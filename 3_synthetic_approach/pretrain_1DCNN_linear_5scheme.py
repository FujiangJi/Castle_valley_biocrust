...
model_saved_path = "../2_saved_models/pretrained_spectral_cnn_linear_5scheme.pt"
result_path = "../3_results/pretrained_model_estimation_linear_5scheme.csv"
loss_path = "../3_results/pretrained_model_loss_linear_5scheme.csv"
batch_size = 32
lr = 0.001
n_epoches = 600
test_size = 0.2
...
def main():
    ...
    print("\nStart training 1D-CNN linear_5scheme...")
