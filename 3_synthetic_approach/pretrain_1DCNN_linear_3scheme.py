...
# 1. CONFIGURATION
# ==========================================
csv_path = "../1_data/Processed_data/synthetic_mixtures_linear.csv"  # linear synthetic data
model_saved_path = "../2_saved_models/pretrained_spectral_cnn_linear_3scheme.pt"
result_path = "../3_results/pretrained_model_estimation_linear_3scheme.csv"
loss_path = "../3_results/pretrained_model_loss_linear_3scheme.csv"
batch_size = 32
lr = 0.001
n_epoches = 600
test_size = 0.2
...
def main():
    ...
    print("\nStart training 1D-CNN linear_3scheme...")
    for epoch in range(1, n_epoches + 1):
        train_loss = train_one_epoch(model, train_loader, optimizer, loss_fn, noise_std=0.02, scale_std=0.0)
