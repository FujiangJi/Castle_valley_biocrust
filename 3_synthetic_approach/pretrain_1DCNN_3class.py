...
model_saved_path = "../2_saved_models/pretrained_spectral_cnn_3class.pt"
result_path = "../3_results/pretrained_model_estimation_3class.csv"
loss_path = "../3_results/pretrained_model_loss_3class.csv"
batch_size = 32
lr = 0.001
n_epoches = 600
test_size = 0.2
...
def merge_targets(df):
    ...
    df = df.drop(columns=["frac_Litter", "frac_Vegetation", "frac_DkCy",
