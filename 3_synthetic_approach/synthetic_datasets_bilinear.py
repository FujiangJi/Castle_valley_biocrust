...
synth.to_csv("../1_data/Processed_data/synthetic_mixtures_bilinear.csv", index=False)
print(f"Saved {len(synth)} synthetic samples to synthetic_mixtures_bilinear.csv")
