...
model_saved_path = "../2_saved_models/pretrained_spectral_cnn_bilinear_5scheme.pt"
result_path = "../3_results/pretrained_model_estimation_bilinear_5scheme.csv"
loss_path = "../3_results/pretrained_model_loss_bilinear_5scheme.csv"
batch_size = 32
lr = 0.001
n_epoches = 600
test_size = 0.2
...
def load_data(csv_path):
    ...
    # Merge Litter into Vegetation (Vegetation column = Litter + Vegetation)
    df["frac_Vegetation"] = df["frac_Litter"] + df["frac_Vegetation"]
    df = df.drop(columns=["frac_Litter"])
...
def main():
    ...
    print("\nStart training 1D-CNN bilinear_5scheme...")
