...
def main():
    ...
    # Fine-tuned 1D-CNN, bilinear mixing (higher accuracy than linear) — 5-class scheme
    df = pd.read_csv(cnn_dir / "final_model_estimation_bilinear_5scheme.csv")
    ...
    for p in plots_list:
        ...
        for t_idx, (tcol, pcol, label) in enumerate(zip(target_cols, pred_cols, heatmap_labels)):
            ...
            ax.set_xticklabels(treats, fontsize=8, rotation=0, ha='center')
