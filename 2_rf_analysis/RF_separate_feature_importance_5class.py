...
def load_data(csv_path):
    ...
    # Merge frac_Litter + frac_Vegetation
...
out_csv = "../2_results/rf_feature_importance_5class_predictions.csv"
permu_imp_csv = "../2_results/rf_feature_importance_5class_permu_imp.csv"
feature_imp_csv = "../2_results/rf_feature_importance_5class_feature_imp.csv"
