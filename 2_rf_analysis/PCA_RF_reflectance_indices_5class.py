...
out_csv = "../2_results/pca_rf_reflectance_indices_5class.csv"
log_path = "../2_results/pca_rf_reflectance_indices_5class.log"
...
#   - Reduces correlated spectral bands + indices to fewer components
# Changes from v2:
