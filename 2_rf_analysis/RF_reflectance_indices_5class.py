...
#******************************************************************#
csv_path = "../1_data/Processed_data/measured_mixtures_with_indices.csv"
out_csv = "../2_results/rf_reflectance_indices_5class.csv"
log_path = "../2_results/rf_reflectance_indices_5class.log"
...
def load_data(csv_path):
    ...
    print(f"Loaded {X.shape[0]} samples, {X.shape[1]} features (spectral bands + indices).")
...
#   - No PCA — raw reflectance + spectral indices fed directly to RF
#   - Pipeline still wraps StandardScaler → RF to prevent data leakage
#   - Proper nested CV: tuning inside each outer fold
# ==============================================================
